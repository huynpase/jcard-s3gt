    ...
    class DAO_GramSetting
    {
        public DTO_GramSetting ReadGramSetting(string iniPath)
        {
            ...
            try
            {
                ...
                gramSettDTO.Fontsize = int.Parse(ini.ReadValue("Sample", "Fontsize", Constants.Fontsize));
                ...
                gramSettDTO.JP_Fontsize = int.Parse(ini.ReadValue("JPMeaning", "JP_Fontsize", Constants.JP_Fontsize));
                ...
                gramSettDTO.VN_Fontsize = int.Parse(ini.ReadValue("VNMeaning", "VN_Fontsize", Constants.VN_Fontsize));
                ...
                gramSettDTO.Ex_Fontsize = int.Parse(ini.ReadValue("Example", "Ex_Fontsize", Constants.Ex_Fontsize));
            ...
            catch
            {
                ...
                gramSettDTO.Fontsize = int.Parse(Constants.Fontsize);
                ...
                gramSettDTO.JP_Fontsize = int.Parse(Constants.JP_Fontsize);
                ...
                gramSettDTO.VN_Fontsize = int.Parse(Constants.VN_Fontsize);
                ...
                gramSettDTO.Ex_Fontsize = int.Parse(Constants.Ex_Fontsize);
        ...
        public void WriteGramSettings(DTO_GramSetting gramSettDTO, string iniPath)
        {
            ...
            ini.WriteValue("Sample", "Fontsize", gramSettDTO.Fontsize.ToString());
            ...
            ini.WriteValue("JPMeaning", "JP_Fontsize", gramSettDTO.JP_Fontsize.ToString());
            ...
            ini.WriteValue("VNMeaning", "VN_Fontsize", gramSettDTO.VN_Fontsize.ToString());
            ...
            ini.WriteValue("Example", "Ex_Fontsize", gramSettDTO.Ex_Fontsize.ToString());
