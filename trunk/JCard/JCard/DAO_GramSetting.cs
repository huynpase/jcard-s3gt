    ...
    class DAO_GramSetting
    {
        public DTO_GramSetting ReadGramSetting(string iniPath)
        {
            ...
            try
            {
                ...
                gramSettDTO.JP_Fontsize = int.Parse(ini.ReadValue("JPMeaning", "Fontsize", Constants.JP_Fontsize));
                ...
                gramSettDTO.VN_Fontsize = int.Parse(ini.ReadValue("VNMeaning", "Fontsize", Constants.VN_Fontsize));
                ...
                gramSettDTO.Ex_Fontsize = int.Parse(ini.ReadValue("Example", "Fontsize", Constants.Ex_Fontsize));
