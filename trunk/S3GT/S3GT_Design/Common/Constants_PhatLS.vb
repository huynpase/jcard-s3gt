Public Class Constants_PhatLS
    ...
    Public Const STR_SEARCH_VOC_COLUMN_EXAMPLE As Int16 = 6
    Public Const STR_SEARCH_VOC_COLUMN_ID As Int16 = 7
    ...
    Public Const INT_VOC_DB_COLUMN_EXAMPLE As Int32 = 14
    Public Const INT_VOC_DB_COLUMN_TYPE_IN_STRING As Int32 = 15
