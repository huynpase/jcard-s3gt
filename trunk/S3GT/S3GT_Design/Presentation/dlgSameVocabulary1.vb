...
Public Class dlgSameVocabulary1
    ...
    Private Sub btnOverride_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        DialogResult = ProcessSameVocabulary(Constants_LanhVC.INT_OVERRIDE)
        Me.Close()
    End Sub

    Private Sub btnMergeKanji_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        DialogResult = ProcessSameVocabulary(Constants_LanhVC.INT_MERGE_KANJI)
        Me.Close()
    End Sub

    Private Sub btnMergeMeaning_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        DialogResult = ProcessSameVocabulary(Constants_LanhVC.INT_MERGE_MEANING)
        Me.Close()
    End Sub

    Private Sub btnSkip_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.DialogResult = Constants_LanhVC.INT_SKIP
        Me.Close()
    End Sub

    Private Sub btnProcess_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOverwrite.Click
        btnOverride_Click(sender, e)
    End Sub

    Private Sub dlgSameVocabulary1_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Me.DialogResult = Constants_LanhVC.INT_SKIP
    End Sub
