Public Class Constants_LanhVC
    ...
    Public Const STR_SQL_VOC_CHECK_EXIST_IN_TOPIC As String = "SELECT * from S3GT_VOC where Hiragana = '{0}' and Topic_ID ={1}"
    Public Const STR_SQL_VOC_CHECK_EXIST_IN_TOPIC2 As String = "SELECT * from S3GT_VOC where Hiragana = '{0}' and Kanji = '{1}' and Topic_ID ={2}"
    Public Const STR_SQL_VOC_CHECK_EXIST_IN_TOPIC3 As String = "SELECT * from S3GT_VOC where Kanji = '{0}' and Topic_ID = {1}"
    ...
    Public Const STR_MSG_ERR_003 As String = "Another vocabulary with the same Hiragana and belongs to the same Topic existed. " & STR_NEW_LINE & STR_NEW_LINE & "Please choose an action."
    ...
    'Parameters Table Column Names - Added by QuanTDA
