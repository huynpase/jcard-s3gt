Public Class TopicDAO
    ...
    ''' <summary>
    ''' Get Topic by Topic Name and Group Name
    ''' </summary>
    ''' <param name="strGroupName">Group Name</param>
    ''' <param name="strTopicName">Topic Name</param>
    ''' <returns>datatable of Topic Group(ID, Name, Description)</returns>
    ''' <remarks></remarks>
    Public Function GetTopicByTopicNameGroupName(ByVal strGroupName As String, ByVal strTopicName As String) As DataTable
        Dim objTopicTable As DataTable
        Dim strSQL As String
        Dim objBaseDAO As BaseDAO
        ...
        'set value for SQL
        strSQL = String.Format(Constants_LanhVC.STR_SQL_TPC_GET_TOPIC_BY_GROUP_NAME_TOPIC_NAME, _
                               Utils.Replace(strGroupName), Utils.Replace(strTopicName))
