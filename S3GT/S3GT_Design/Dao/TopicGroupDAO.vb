Public Class TopicGroupDAO
    ...
    ''' <summary>
    ''' Get TopicGroupID by TopicGroupName
    ''' </summary>
    ''' <param name="strTopicGroupName">Topic Group ID</param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetTopicGroupID(ByVal strTopicGroupName As String) As Integer
        ...
        'set value for SQL
        strSQL = String.Format(Constants_LanhVC.STR_SQL_TPG_GET_TOPIC_GROUP_ID_BY_NAME, strTopicGroupName)
        ...
        If (dataTable.Rows.Count > 0) Then
            Return Integer.Parse(dataTable.Rows(0)(0))
        Else
            Return 0
        End If
